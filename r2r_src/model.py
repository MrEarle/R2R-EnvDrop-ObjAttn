...
class AttnDecoderLSTM(nn.Module):
    ...
    def __init__(self, embedding_size, hidden_size, dropout_ratio, feature_size=2048 + 4, obj_attn_size=256):
...
class SpeakerDecoder(nn.Module):
    def __init__(self, vocab_size, embedding_size, padding_idx, hidden_size, dropout_ratio):
        ...
        self.baseline_projection = nn.Sequential(
            nn.Linear(hidden_size, 128), nn.ReLU(), nn.Dropout(dropout_ratio), nn.Linear(128, 1)
        )
