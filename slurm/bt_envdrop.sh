...
#SBATCH --output=/home/mrearle/repos/R2R-EnvDrop-ObjAttn/slurm/logs/envdrop_out-%j.log    # Output name (%j is replaced by job ID)
#SBATCH --error=/home/mrearle/repos/R2R-EnvDrop-ObjAttn/slurm/logs/envdrop_err-%j.log     # Output errors (optional)
