#!/bin/bash
#SBATCH --job-name=pretrain_base_red
#SBATCH --ntasks=1                  # Run only one task
#SBATCH --output=/home/mrearle/repos/R2R-EnvDrop-ObjAttn/slurm/logs/pretrain_base_red-%j.log    # Output name (%j is replaced by job ID)
...
name="craft_pretrain/base" # Reduced!
flag="--attn soft --train listener 
      ...
      --reduced_envs
      --dataset r2r
      --load snap/base/craft_reduced/state_dict/best_val_unseen
