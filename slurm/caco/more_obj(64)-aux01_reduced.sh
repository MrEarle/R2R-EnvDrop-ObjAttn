...
flag="--attn soft --train listener
      ...
      --reduced_envs
      --dataset craft
      --load snap/obj/craft_obj(64)_aux(0.1)_reduced/state_dict/latest_iter
      --subout max --dropout 0.5 --optim rms --lr 1e-4 --iters 180000 --maxAction 35"
mkdir -p snap/$name
